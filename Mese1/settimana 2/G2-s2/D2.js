...
if (a === 8 || b === 8 || a + b === 8 ||  a - b === 8 || b - a === 8)
{
  ...
  console.log ('nessun risultato giusto')
}
...
*/
  ...
  if (totalShoppingcart > 50){
    console.log('ha diritto alla sped. gratuita');
  } else {
    console.log('addebito spese di sped. quindi', totalShoppingcart + speseSpedizione);
  }
