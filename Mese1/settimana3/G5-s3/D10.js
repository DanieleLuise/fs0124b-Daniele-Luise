...
me.skills = ['Javscript', 'Java', 'Phyton'];
console.log(me);
...
*/
  ...
  function whoIsBigger(num1, num2){
    ...
    let piùAlto = whoIsBigger(3, 7);
console.log('il numero più alto è ', piùAlto);
...
let stringaNumeri = "Daniele2Luise3";
...
let giorniPassati = howManyDays(data);
...
function isTodayMyBirthday(){
  let oggi = new Date();
  let mioCompleanno = new Date(oggi.getFullYear(), 7, 26);
...
*/
let onlyInLastMillennium = (array) => {
...
let sumAllTheYears = (array) => {
  return array.reduce((a, b) => a + parseInt(a.Year), 0);
}
